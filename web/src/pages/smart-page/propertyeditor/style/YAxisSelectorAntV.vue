          ...
          <a-form-model-item v-show="showProperty('position')" :label="$t('chart.position')" class="form-item">
            <a-radio-group v-model="axisForm.position" size="small" @change="changeYAxisStyle('position')">
              ...
              <div v-else-if="chart.type === 'bidirectional-bar'">
                <a-radio-button value="right">{{ $t('chart.text_pos_top') }}</a-radio-button>
                <a-radio-button value="left">{{ $t('chart.text_pos_bottom') }}</a-radio-button>
              </div>
            </a-radio-group>
          </a-form-model-item>
          ...
          <span v-show="showProperty('axisValue')">
            ...
            <span v-show="!axisForm.axisValue.auto">
              ...
              <a-form-model-item class="form-item">
                ...
                <a-input v-model="axisForm.axisValue.splitCount" @blur="changeYAxisStyle('axisValue')" />
              </a-form-model-item>
            </span>
          </span>
