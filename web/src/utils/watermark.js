 ...
 *  水印DOM id
 */
const WATER_MARK_DOM_ID = 'helm_water_mark';
let helmWaterMarkIntervalId = null;
/**
 * 
 * @param {'YYYY-MM-DD HH:mm'} date 
 * @returns 
 */
function formatDate() {
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        helmWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (helmWaterMarkIntervalId) {
            clearInterval(helmWaterMarkIntervalId);
            helmWaterMarkIntervalId = null;
        }
    },
};
