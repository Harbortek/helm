...
package com.harbortek.helm.websocket.service.impl;

import com.harbortek.helm.websocket.entity.WsMessage;
import com.harbortek.helm.websocket.service.WsService;
...
public class StandaloneWsService implements WsService {
    ...
    public void releaseMessage(WsMessage wsMessage){
        ...
        messagingTemplate.convertAndSendToUser(String.valueOf(wsMessage.getUserId()), wsMessage.getTopic(),wsMessage.getPayload());
    }
}
