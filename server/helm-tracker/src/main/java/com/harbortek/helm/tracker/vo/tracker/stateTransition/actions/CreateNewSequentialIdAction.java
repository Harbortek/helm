...
@ActionType(type = StateTransitionActions.ACTION_TYPE_CREATE_A_NEW_SEQUENTIAL_ID)
public class CreateNewSequentialIdAction extends TrackerStateTransitionAction {
}
