...
/**
 * @description 引用块元素转HTML
 * @author wangfupeng (Java version translator)
 */
public class BlockquoteToHtml implements HtmlConfigRegistry.ElemToHtmlConf {
    ...
    public ElemToHtmlFunction getElemToHtml() {
        return (elemNode, childrenHtml, editor) -> {
            ...
            return String.format("<blockquote>%s</blockquote>", childrenHtml);
        };
    }
}