...
@ActionType(type = StateTransitionActions.ACTION_TYPE_CREATE_NEW_UP_DOWNSTREAM_REFERRING_ITEMS)
public class CreateNewUpDownstreamReferringItemAction extends TrackerStateTransitionAction {
}
