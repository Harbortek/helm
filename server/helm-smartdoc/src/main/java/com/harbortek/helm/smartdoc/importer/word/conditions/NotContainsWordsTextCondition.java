...
@ParagraphCondition(id= ConditionTypes.NOT_CONTAINS_WORDS,hasArgument = true)
public class NotContainsWordsTextCondition implements IParagraphCondition {
    private boolean caseSensitive;

    public NotContainsWordsTextCondition() {
    }
