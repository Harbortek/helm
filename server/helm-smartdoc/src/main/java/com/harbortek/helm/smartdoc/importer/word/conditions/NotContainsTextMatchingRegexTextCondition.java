...
@ParagraphCondition(id= ConditionTypes.NOT_CONTAINS_TEXT_MATCHING_REGEX,hasArgument = true)
public class NotContainsTextMatchingRegexTextCondition implements IParagraphCondition {
    public NotContainsTextMatchingRegexTextCondition() {
    }
