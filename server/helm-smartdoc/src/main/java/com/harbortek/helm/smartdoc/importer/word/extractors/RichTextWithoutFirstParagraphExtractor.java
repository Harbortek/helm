...
@ValueExtractor(id= ValueExtractorTypes.RICH_TEXT_WITHOUT_1ST_PARAGRAPH,hasArgument = false)
public class RichTextWithoutFirstParagraphExtractor implements IValueExtractor{
    @Override
    public Object extractValue(Element paragraph, String argument) {
        //List<Element> subList = paragraphs.subList(1,paragraphs.size()-1);
