...
public class AHandler implements TagHandler {
    ...
    public void handleTag(Node node, WordprocessingMLPackage wordMLPackage) {
        if (node.hasAttr(Constants.A_DATA_SRC)) {
            try {
    ...
    private PictureRenderData parsePicture(Node image) {
        String uri = image.attr(Constants.A_DATA_SRC);
        ...
        image.attr(Constants.A_DATA_SRC, uri);
