...
@ValueExtractor(id= ValueExtractorTypes.TEXT_WITH_REGEX,hasArgument = true)
public class TextMatchingRegexExtractor implements IValueExtractor{
    @Override
    public Object extractValue(Element paragraph, String argument) {
        ...
        return matcher.find() ? (matcher.groupCount() > 0 ? matcher.group(1) : matcher.group()) : null;
    }
}
