...
public class AttributeDefinitionReal extends AttributeDefinition {
	...
	public AttributeDefinitionReal(String id, String name, Datatype dataType) {
		super(id, name, dataType);
	}

	public AttributeDefinitionReal(Node attributeDefinition, Map<String, Datatype> dataTypes) {
