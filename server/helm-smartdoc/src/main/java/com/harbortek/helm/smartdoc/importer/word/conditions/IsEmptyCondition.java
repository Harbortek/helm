...
@ParagraphCondition(id= ConditionTypes.IS_EMPTY)
public class IsEmptyCondition implements IParagraphCondition {
    ...
    public boolean isSatisfied(Element paragraph, String argument) {
        ...
        return StringUtils.isEmpty(text) || StringUtils.trim(text).isEmpty();
    }
