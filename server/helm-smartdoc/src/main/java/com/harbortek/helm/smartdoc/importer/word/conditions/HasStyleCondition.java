...
@ParagraphCondition(id = ConditionTypes.HAS_STYLE, hasArgument = true)
public class HasStyleCondition implements IParagraphCondition {
    @Override
    public boolean isSatisfied(Element paragraph, String argument) {
        return paragraph.classNames().contains(argument);
    }
