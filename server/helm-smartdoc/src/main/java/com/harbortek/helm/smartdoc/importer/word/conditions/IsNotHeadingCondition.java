...
@ParagraphCondition(id= ConditionTypes.IS_NOT_HEADING)
public class IsNotHeadingCondition implements IParagraphCondition {
    @Override
    public boolean isSatisfied(Element paragraph, String argument) {
        return !paragraph.is("h1,h2,h3,h4,h5,h6");
    }
