...
public class AttributeDefinitionInteger extends AttributeDefinition {
	...
	public AttributeDefinitionInteger(String id, String name, Datatype dataType) {
		super(id, name, dataType);
	}

	public AttributeDefinitionInteger(Node attributeDefinition, Map<String, Datatype> dataTypes) {
