    ...
    private String translateVirtualSprintTable(String[] elementNames) {
        ...
        String sql = """
                select p.item_no            as '编号',
                       ...
                       tv.name              as '目标版本',
                       p.total_working_hours as '总工时',
                       p.completed_working_hours as '已完成工时',
                       p.remaining_working_hours as '剩余工时',
                       u1.name              as '创建者',
    ...
    private String translateVirtualVersionTable(String[] elementNames) {
        ...
        String sql = """
                select tv.name               as '目标版本',
                       ...
                       tv.real_end_date      as '实际完成日期',
                       tv.total_working_hours as '总工时',
                       tv.completed_working_hours as '已完成工时',
                       tv.remaining_working_hours as '剩余工时',
                       u1.name               as '创建者',
